...
export default function SecretCodeCard({
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (code === '111025') {
      if (typeof setUnlocked === 'function') setUnlocked(true); // ✅ switch song
      if (typeof setMusicPlaying === 'function') setMusicPlaying(true); // play second song
      onCorrect();
    } else {
    ...
    <AnimatePresence>
      ...
      >
        ...
        <h2 className="text-xl font-medium text-gradient mb-4 text-center relative z-10">
          A little secret between us! Enter the code to unlock more love.
        </h2>
